<template>
    ...
    <div class="sub-content-client3-info">
        ...
        <div class="attend" style="padding-left: 10px;">
            <div class="line-chart" id="lineChartClient" style="width: 490px;height:210px;margin-top:0%"></div>
        </div>
    </div>
</template>
<script>
export default {
    ...
    methods: {
        ...
        getLineChart() {
            ...
            var myChart = echarts.init(document.getElementById('lineChartClient'));
            // 指定图表的配置项和数据
            var option = {
                title: {
                    text: '单位/GB',
